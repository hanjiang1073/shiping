...
export default {
    ...
    methods: {
        ...
        handleQuery(row) {
            ...
            axios.post('http://localhost:8080/ShipOrder/retrieveBill', { "shiporderid": row.shiporderid }, {
                headers: {
        ...
        getAllOrders() {
            ...
            axios.get('http://localhost:8080/ShipOrder/getOrders', {
                headers: {
                    Authorization: this.$store.state.token
                }
            }).then(response => {
        ...
        createOrder() {
            axios.post('http://localhost:8080/ShipOrder/createOrder', {
